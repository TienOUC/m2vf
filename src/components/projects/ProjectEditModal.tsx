      ...
      <div className="bg-card rounded-xl shadow-lg border border-border w-full max-w-md transition-all duration-300">
        <div className="p-6">
          <div className="flex justify-between items-center mb-6">
            <h3 className="text-lg font-semibold text-foreground">编辑项目信息</h3>
            <button
              onClick={onClose}
          ...
          <div className="space-y-4">
            <div>
              <label htmlFor="editProjectName" className="block text-sm font-medium text-foreground mb-1.5">
                项目名称 *
              </label>
              <input
                type="text"
            ...
            <div>
              <label htmlFor="editProjectDescription" className="block text-sm font-medium text-foreground mb-1.5">
                项目描述
              </label>
              <textarea
